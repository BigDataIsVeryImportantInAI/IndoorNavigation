...
public final class Databases {
	public static final class CreateGroupsDB implements BaseColumns{
		public static final String GROUPNAME = "gname";
        public static final String CNTMEMBER = "cntmember";
        public static final String MASTER = "gmaster";
        public static final String _TABLENAME = "GROUPS";
        public static final String _CREATE = 
            "create table "+_TABLENAME+"("
                    +_ID+" integer primary key autoincrement, "
                    +GROUPNAME+" text not null unique, " 
                    +CNTMEMBER+" int not null , "
